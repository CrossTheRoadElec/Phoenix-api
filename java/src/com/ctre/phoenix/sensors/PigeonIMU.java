...
public class PigeonIMU {
   ...
   *            If zero, no blocking or checking is performed.
     ...
     * ConfigTemperatureCompensationDisable was added
     * to better match with the lower level API.
	...
	public ErrorCode configTemperatureCompensationEnable(boolean bTempCompEnable, int timeoutMs) {
		int retval = PigeonImuJNI.JNI_ConfigTemperatureCompensationDisable(m_handle, (!bTempCompEnable) ? 1 : 0, timeoutMs);
		return ErrorCode.valueOf(retval);
	}
	public ErrorCode configTemperatureCompensationEnable(boolean bTempCompEnable) {
		int timeoutMs = 0;
		return configTemperatureCompensationDisable(bTempCompEnable, timeoutMs);
	}
    /**
     ...
     * @return Error Code generated by function. 0 indicates no error.
     */
	public ErrorCode configTemperatureCompensationDisable(boolean bTempCompDisable, int timeoutMs) {
		int retval = PigeonImuJNI.JNI_ConfigTemperatureCompensationDisable(m_handle, bTempCompDisable ? 1 : 0, timeoutMs);
		return ErrorCode.valueOf(retval);
	}
	public ErrorCode configTemperatureCompensationDisable(boolean bTempCompDisable) {
		int timeoutMs = 0;
		return configTemperatureCompensationDisable(bTempCompDisable, timeoutMs);
	}
