...
forward/reverse directions.
   ...
   * @return           Error Code generated by function.  0 indicates no error.   */
	...
	{
		int retval = MotControllerJNI.SetStatusFramePeriod(m_handle, frame.value, periodMs, timeoutMs);
		return ErrorCode.valueOf(retval);
	}
  /**
   ...
   * @return                   Error Code generated by function.  0 indicates no error.   */
	...
	{
		int retval = MotControllerJNI.ConfigForwardLimitSwitchSource(m_handle, type.value, normalOpenOrClose.value, deviceID, timeoutMs);
		return ErrorCode.valueOf(retval);
	}
  /**
   ...
   * @return  Last Error Code generated by a function.   */
	...
	{
		return ErrorCode.FeatureNotSupported; // TODO
	}
