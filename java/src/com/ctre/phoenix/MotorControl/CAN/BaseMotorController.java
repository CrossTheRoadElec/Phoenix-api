...
public abstract class BaseMotorController implements com.ctre.phoenix.motorcontrol.IMotorController {
	...
	public ErrorCode configSelectedFeedbackSensor(RemoteFeedbackDevice feedbackDevice, int timeoutMs) {
		int e1 = MotControllerJNI.ConfigRemoteFeedbackFilter(m_handle, feedbackDevice._arbId,
				feedbackDevice._peripheralIndex, feedbackDevice._reserved, timeoutMs);
	...
	public int getClosedLoopError() {
		return MotControllerJNI.GetClosedLoopError(m_handle,
				0); /* todo: remove slotIdx */
	}
	...
	public double getIntegralAccumulator() {
		return MotControllerJNI.GetIntegralAccumulator(m_handle,
				0); /* todo: remove slotIdx */
	}

	public double getErrorDerivative() {
		return MotControllerJNI.GetErrorDerivative(m_handle,
				0); /* todo: remove slotIdx */
	}
	...
	public ErrorCode configSetParameter(ParamEnum param, double value, int subValue, int ordinal, int timeoutMs) {
		int retval = MotControllerJNI.ConfigSetParameter(m_handle, param.value, (float) value, subValue, ordinal,
				timeoutMs);
		return ErrorCode.valueOf(retval);
	}
