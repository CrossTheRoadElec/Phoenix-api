...
public class ServoGoStraightWithImu implements com.ctre.phoenix.ILoopable
{
    ...
    public ServoGoStraightWithImu(com.ctre.phoenix.Sensors.PigeonImu pigeonImu, IDrivetrain IDrivetrain, Styles.Basic selectedStyle, ServoParameters parameters, float Y, float targetHeading, float maxOutput)
    {
        _pidgey = pigeonImu;
