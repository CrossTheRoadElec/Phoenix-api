...
public abstract class BaseMotorController implements com.ctre.phoenix.motorcontrol.IMotorController {
    ...
    protected ErrorCode baseConfigAllSettings(BaseMotorControllerConfiguration allConfigs, int timeoutMs) {
        ...
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 332, allConfigs.feedbackNotContinuous ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 336, allConfigs.remoteSensorClosedLoopDisableNeutralOnLOS ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 320, allConfigs.clearPositionOnLimitF ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 321, allConfigs.clearPositionOnLimitR ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 322, allConfigs.clearPositionOnQuadIdx ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 423, allConfigs.limitSwitchDisableNeutralOnLOS ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 425, allConfigs.softLimitDisableNeutralOnLOS ? 1.0 : 0.0, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 430, (double) allConfigs.pulseWidthPeriod_EdgesPerRot, 0, 0, timeoutMs));
        errorCollection.NewError(MotControllerJNI.ConfigSetParameter(m_handle, 431, (double) allConfigs.pulseWidthPeriod_FilterWindowSz, 0, 0, timeoutMs));
    ...
    protected void baseGetAllConfigs(BaseMotorControllerConfiguration allConfigs, int timeoutMs) {
        ...
        allConfigs.forwardSoftLimitEnable = configGetParameter(ParamEnum.eForwardSoftLimitEnable, 0, timeoutMs) == 1.0;
        allConfigs.reverseSoftLimitEnable = configGetParameter(ParamEnum.eReverseSoftLimitEnable, 0, timeoutMs) == 1.0;
        ...
        allConfigs.auxPIDPolarity = configGetParameter(ParamEnum.ePIDLoopPolarity, 1, timeoutMs) == 1.0;
        ...
        allConfigs.feedbackNotContinuous = configGetParameter(ParamEnum.eFeedbackNotContinuous, 0, timeoutMs) == 1.0;
        allConfigs.remoteSensorClosedLoopDisableNeutralOnLOS = configGetParameter(ParamEnum.eRemoteSensorClosedLoopDisableNeutralOnLOS, 0, timeoutMs) == 1.0;
        allConfigs.clearPositionOnLimitF = configGetParameter(ParamEnum.eClearPositionOnLimitF, 0, timeoutMs) == 1.0;
        allConfigs.clearPositionOnLimitR = configGetParameter(ParamEnum.eClearPositionOnLimitR, 0, timeoutMs) == 1.0;
        allConfigs.clearPositionOnQuadIdx = configGetParameter(ParamEnum.eClearPositionOnQuadIdx, 0, timeoutMs) == 1.0;
        allConfigs.limitSwitchDisableNeutralOnLOS = configGetParameter(ParamEnum.eLimitSwitchDisableNeutralOnLOS, 0, timeoutMs) == 1.0;
        allConfigs.softLimitDisableNeutralOnLOS = configGetParameter(ParamEnum.eSoftLimitDisableNeutralOnLOS, 0, timeoutMs) == 1.0;
