...
public class MotControllerJNI extends CTREJNIWrapper {
    ...
    public static native int JNI_ConfigFeedbackNotContinuous(long handle, boolean feedbackNotContinuous, int timeoutMs);
 
    public static native int JNI_ConfigRemoteSensorClosedLoopDisableNeutralOnLOS(long handle, boolean remoteSensorClosedLoopDisableNeutralOnLOS, int timeoutMs);
    ...
    public static native int JNI_ConfigLimitSwitchDisableNeutralOnLOS(long handle, boolean limitSwitchDisableNeutralOnLOS, int timeoutMs);
 
    public static native int JNI_ConfigSoftLimitDisableNeutralOnLOS(long handle, boolean softLimitDisableNeutralOnLOS, int timeoutMs);
 
    public static native int JNI_ConfigPulseWidthPeriod_EdgesPerRot(long handle, int pulseWidthPeriod_EdgesPerRot, int timeoutMs);
 
    public static native int JNI_ConfigPulseWidthPeriod_FilterWindowSz(long handle, int pulseWidthPeriod_FilterWindowSz, int timeoutMs);
