...
forward/reverse directions.
   ...
   * @param timeoutMs Timeout value in ms.  @see #ConfigOpenLoopRamp
   * @param pidIdx Which closed loop to manipulate. 0 for primary, 1 for cascaded secondary loop.
   * @return           Error Code generated by function.  0 indicates no error.   */
   ...
   * @param pidIdx Which closed loop to manipulate. 0 for primary, 1 for cascaded secondary loop.
   **/
	public static native void SelectProfileSlotSpecificPID(long handle, int slotIdx, int pidIdx);
  /**
