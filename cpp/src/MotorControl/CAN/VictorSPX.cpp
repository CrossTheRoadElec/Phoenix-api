...
ErrorCode VictorSPX::ConfigAllSettings(VictorSPXConfiguration allConfigs, int timeoutMs) {
	...
	allConfigs.Slot_0.remoteSensorSource, allConfigs.Slot_0.RemoteFeedbackFilter, 0, timeoutMs);
	...
	allConfigs.Slot_1.remoteSensorSource, allConfigs.Slot_1.RemoteFeedbackFilter, 1, timeoutMs);
	...
	allConfigs.Slot_2.remoteSensorSource, allConfigs.Slot_2.RemoteFeedbackFilter, 2, timeoutMs);
	...
	ConfigRemoteFeedbackFilter(allConfigs.Slot_3.deviceID, allConfigs.Slot_3.remoteSensorSource, allConfigs.Slot_3.RemoteFeedbackFilter, 3, timeoutMs);
	...
	//------ remote limit switch ----------//	
	ConfigForwardLimitSwitchSource(allConfigs.ForwardLimitSwitchSource, timeoutMs);
	ConfigForwardLimitSwitchNormal(allConfigs.ForwardLimitSwitchNormal, timeoutMs);
	ConfigReverseLimitSwitchSource(allConfigs.ReverseLimitSwitchSource, timeoutMs);
	ConfigReverseLimitSwitchNormal(allConfigs.ReverseLimitSwitchNormal, timeoutMs);
	...
	ConfigIntegralZone(0, allConfigs.Slot_0.IntegralZone, timeoutMs);
	...
	ConfigIntegralZone(1, allConfigs.Slot_1.IntegralZone, timeoutMs);
	...
	ConfigIntegralZone(2, allConfigs.Slot_2.IntegralZone, timeoutMs);
	...
	ConfigIntegralZone(3, allConfigs.Slot_3.IntegralZone, timeoutMs);
