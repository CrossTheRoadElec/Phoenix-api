...
//	_driveTrain = driveTrain;
//}
//bool ServoZeroTurnWithImu::Set(float targetHeading, float headingTolerance,
//		float maxOutput) {
//	_maxOutput = maxOutput;
...
//	}
//}
//bool ServoZeroTurnWithImu::ZeroTurn(float targetHeading,
//		float headingTolerance) {
//	if (servoParams->P == 0 && servoParams->I == 0 && servoParams->D == 0)
//		HAL_SendError(false, 1, false,
//				"CTR: Servo Zero Turn With Imu has no PID values, cannot turn",
//				"", "", true);
...
//				- (currentAngularRate) * servoParams->D;
//		X = -X;
