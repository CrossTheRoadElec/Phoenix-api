...
//namespace motion {
//
//ServoGoStraightWithImu::ServoGoStraightWithImu(ctre::PigeonIMU *pigeonImu,
//		ctre::phoenix::drive::IDrivetrain *driveTrain,
//		ctre::phoenix::drive::Styles::Basic selectedStyle, ServoParameters *parameters,
//		float Y, float targetHeading, float headingTolerance, float maxOutput) {
//	_pidgey = pigeonImu;
...
//	_selectedStyle = selectedStyle;
//}
//bool ServoGoStraightWithImu::Set(float Y, float targetHeading,
...
//	}
//}
//bool ServoGoStraightWithImu::GoStraight(float Y, float targetHeading,
//		float headingTolerance) {
//	if (servoParameters->P == 0 && servoParameters->I == 0
//			&& servoParameters->D == 0)
//		HAL_SendError(false, 1, false,
//				"CTR: Servo Go Straight With Imu has no PID values, cannot go straight",
//				"", "", true);
...
//				- (currentAngularRate) * servoParameters->D;
...
//			_driveTrain->Set(ctre::Drive::Styles::Basic::PercentOutputBasic, Y,
//					X);
//			break;
