...
//	_selectedStyle = selectedStyle;
//}
//bool ServoGoStraightWithImuSmart::Set(float Y, float targetHeading,
//		float headingTolerance, float maxOutput) {
//	_maxOutput = maxOutput;
...
//	}
//}
//bool ServoGoStraightWithImuSmart::GoStraight(float Y, float targetHeading,
//		float headingTolerance) {
//	if (servoParameters->P == 0 && servoParameters->I == 0
//			&& servoParameters->D == 0)
//		HAL_SendError(false, 1, false,
//				"CTR: Servo Go Straight With Imu Smart has no PID values, cannot go straight",
//				"", "", true);
