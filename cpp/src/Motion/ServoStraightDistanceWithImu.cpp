...
//namespace motion {
//
//ServoStraightDistanceWithImu::ServoStraightDistanceWithImu(
...
//		StraightDrive = new ServoGoStraightWithImuSmart(_pidgey, _driveTrain,
...
//				ctre::Drive::Styles::Smart::VelocityClosedLoop);
//}
//bool ServoStraightDistanceWithImu::Set(float targetHeading,
//		float targetDistance, float headingTolerance, float distanceTolerance,
//		float maxOutput) {
...
//	}
//}
//bool ServoStraightDistanceWithImu::StraightDistance(float targetHeading,
//		float targetDistance, float headingTolerance, float distanceTolerance) {
//	if (straightServoParameters->P == 0 && straightServoParameters->I == 0
//			&& straightServoParameters->D == 0)
//		HAL_SendError(false, 1, false,
//				"CTR: Servo Straight Distance With Imu has no straight PID values, cannot go straight",
//				"", "", true);
//	if (distanceServoParameters->P == 0 && distanceServoParameters->I == 0
//			&& distanceServoParameters->D == 0)
//		HAL_SendError(false, 1, false,
//				"CTR: Servo Straight Distance With Imuhas no distance PID values, cannot go forward",
//				"", "", true);
...
//			- (positionRate) * distanceServoParameters->D; //We want to PID object here
