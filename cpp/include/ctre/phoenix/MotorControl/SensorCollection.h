...
//	};
//
//	explicit SmartMotorController(int deviceNumber);explicit SmartMotorController(int deviceNumber, int controlPeriodMs);DEFAULT_MOVE_CONSTRUCTOR(SmartMotorController);virtual ~SmartMotorController();
//
//	int GetDeviceID();
//
//	// PIDOutput interface
...
//
//	ControlMode::SmartControlMode m_controlMode =
//			ControlMode::SmartControlMode::kPercentVbus;
//	ControlMode::SmartControlMode m_sendMode =
//			ControlMode::SmartControlMode::kPercentVbus;
//
