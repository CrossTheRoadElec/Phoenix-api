...
public:
	Mecanum(CTRE::MotorControl::IMotorController *m1, CTRE::MotorControl::IMotorController *m2, CTRE::MotorControl::IMotorController *m3, CTRE::MotorControl::IMotorController *m4);
	Mecanum(CTRE::Mechanical::Gearbox *m1, CTRE::Mechanical::Gearbox *m2, CTRE::Mechanical::Gearbox *m3, CTRE::Mechanical::Gearbox *m4);
