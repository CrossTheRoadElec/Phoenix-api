...
void GetAllParamsTalon(int id, int timeoutMs, ParamEnumString &paramsToGet, ErrorCodeDoubleString &errorCodes) {
    ...
    for(auto &paramPair : paramsToGet) {    
        double paramVal = testTalon->ConfigGetParameter(paramPair.first, 0, timeoutMs);
        ctre::phoenix::ErrorCode code = testTalon->GetLastError();
        errorCodes.push_back(std::make_pair(std::make_pair(paramVal, code), "testTalon->ConfigGetParameter(" + paramPair.second.name+", 0, " + std::to_string(timeoutMs) + ");"));
    }
}
...
void GetAllParamsVictor(int id, int timeoutMs, ParamEnumString &paramsToGet, ErrorCodeDoubleString &errorCodes) {
    ...
    for(auto &paramPair : paramsToGet) {    
        double paramVal = testVictor->ConfigGetParameter(paramPair.first, 0, timeoutMs);
...
void GetAllParamsPigeon(int id, int timeoutMs, ParamEnumString &paramsToGet, ErrorCodeDoubleString &errorCodes) {
    ...
    for(auto &paramPair : paramsToGet) {    
        double paramVal = testPigeon->ConfigGetParameter(paramPair.first, 0, timeoutMs);
...
void GetAllParamsCANifier(int id, int timeoutMs, ParamEnumString &paramsToGet, ErrorCodeDoubleString &errorCodes) {
    ...
    for(auto &paramPair : paramsToGet) {    
        double paramVal = testCANifier->ConfigGetParameter(paramPair.first, 0, timeoutMs);
...
//    std::shared_ptr<ctre::phoenix::motorcontrol::can::TalonSRX> testTalon = std::make_shared<ctre::phoenix::motorcontrol::can::TalonSRX>(id);
//    for(auto &paramPair : paramsToGet) {    
//        errorCodes.push_back(std::make_pair(std::pair<double, ctre::phoenix::ErrorCode>(testTalon->ConfigGetParameter(paramPair.first, 0, timeoutMs), testTalon->GetLastError()), "testTalon->ConfigGetParameter(" + paramPair.second.name+", 0, " + std::to_string(timeoutMs) + ");"));
//    }
//}
//
...
//    std::shared_ptr<ctre::phoenix::motorcontrol::can::VictorSPX> testVictor = std::make_shared<ctre::phoenix::motorcontrol::can::VictorSPX>(id);
//    for(auto &paramPair : paramsToGet) {    
//        errorCodes.push_back(std::make_pair(std::pair<double, ctre::phoenix::ErrorCode>(testVictor->ConfigGetParameter(paramPair.first, 0, timeoutMs), testVictor->GetLastError()), "testVictor->ConfigGetParameter(" + paramPair.second.name+", 0, " + std::to_string(timeoutMs) + ");"));
//    }
//}
//
...
//    std::shared_ptr<ctre::phoenix::sensors::PigeonIMU> testPigeon = std::make_shared<ctre::phoenix::sensors::PigeonIMU>(id);
//    for(auto &paramPair : paramsToGet) {    
//        errorCodes.push_back(std::make_pair(std::pair<double, ctre::phoenix::ErrorCode>(testCANifier->ConfigGetParameter(paramPair.first, 0, timeoutMs), testCANifier->GetLastError()), "testCANifier->ConfigGetParameter(" + paramPair.second.name+", 0, " + std::to_string(timeoutMs) + ");"));
//    }
//}
//
